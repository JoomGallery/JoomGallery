...
<?php endif;?>
    <div class="row-fluid">
      <div class="alert alert-block alert-info">
        ...
        <?php echo JText::_('COM_JOOMGALLERY_UPLOAD_FTP_UPLOAD_NOTE'); ?>
        <div class="control-group">
          <?php echo $this->form->getLabel('directory'); ?>
          <div class="controls">
            <?php echo $this->form->getInput('directory'); ?>
          </div>
        </div>
      </div>
    </div>
    <div class="row-fluid">
      <div class="span6 well">
        ...
        <div class="control-group">
          <?php echo $this->form->getLabel('subdirectory'); ?>
          <div class="controls">
        ...
        <?php endif; ?>
        <div class="control-group">
          <?php echo $this->form->getLabel('ftpfiles'); ?>
          <div class="controls">
            <?php echo $this->form->getInput('ftpfiles'); ?>
          </div>
        </div>
      </div>
      <div class="span6 well">
        ...
        <div class="control-group">
          <?php echo $this->form->getLabel('file_delete'); ?>
          <div class="controls">
            <?php echo $this->form->getInput('file_delete'); ?>
          </div>
        </div>
