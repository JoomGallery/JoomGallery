...
class JoomGalleryViewHelp extends JoomGalleryView
{
  ...
  public function display($tpl = null)
  {
    ...
    $languages = array( 'de-DE-formal'    => array( 'translator'    => 'JoomGallery::ProjectTeam de-DE (formal)',
                                                    'downloadlink'  => 'https://www.joomgalleryfriends.net/downloads/joomgallery-fuer-joomla-3/sprachdateien/die-deutschen-formellen-sprachdateien.html',
                                                    'flag'          => 'de.png',
                                                    'type'          => 'formal'),
                        'de-DE-informal'  => array( 'translator'    => 'JoomGallery::ProjectTeam de-DE (informal)',
                                                    'downloadlink'  => 'https://www.joomgalleryfriends.net/downloads/joomgallery-fuer-joomla-3/sprachdateien/die-deutschen-informellen-sprachdateien.html',
                                                    'flag'          => 'de.png'),
                        'ar-AA'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Arabic ar-AA',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-arabic-unitag-language-files.html',
                                                    'flag'          => 'sy.png'),
                        'bs-BA'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Bosnian (Bosnia and Herzegovina) bs-BA',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-bosnian-language-files.html',
                                                    'flag'          => 'ba.png'),
                        ...
                        'zh-TW'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Chinese (Taiwan) zh-TW',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-chinese-traditional-language-files.html',
                                                    'flag'          => 'cn.png'),
                        'hr-HR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Croatian (Croatia) hr-HR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-croatian-language-files.html',
                                                    'flag'          => 'hr.png'),
                        'cs-CZ'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Czech (Czech Republic) cs-CZ',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-czech-language-files.html',
                                                    'flag'          => 'cz.png'),
                        'da-DK'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Danish (Denmark) da-DK',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-danish-language-files.html',
                                                    'flag'          => 'dk.png'),
                        ...
                        'fr-FR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::French (France) fr-FR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-french-language-files.html',
                                                    'flag'          => 'fr.png'),
                        'el-GR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Greek (Greece) el-GR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-greek-language-files.html',
                                                    'flag'          => 'gr.png'),
                        'hu-HU-formal'    => array( 'translator'    => 'JoomGallery::TranslationTeam::Hungarian (Hungary) hu-HU (formal)',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-hungarian-formal-language-files.html',
                                                    'flag'          => 'hu.png'),
                        ...
                        'ja-JP'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Japanese (Japan) ja-JP',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-japanese-language-files.html',
                                                    'flag'          => 'jp.png'),
                        'lt-LT'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Lithuanian (Lithuania) lt-LT',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-lithunian-language-files.html',
                                                    'flag'          => 'lt.png'),
                        'lv-LV'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Latvian (Latvia) lv-LV',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-latvian-language-files.html',
                                                    'flag'          => 'lv.png'),
                        'nb-NO'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Norwegian Bokmål (Norway) nb-NO',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-norwegian-language-files.html',
                                                    'flag'          => 'no.png'),
                        'fa-IR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Persian (Iran) fa-IR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-persian-language-files.html',
                                                    'flag'          => 'ir.png'),
                        'pl-PL'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Polish (Poland) pl-PL',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-polish-language-files.html',
                                                    'flag'          => 'pl.png'),
                        'pt-BR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Portuguese (Brazil) pt-BR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-portuguese-brazilian-language-files.html',
                                                    'flag'          => 'br.png'),
                        'pt-PT'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Portuguese (Portugal) pt-PT',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-portuguese-language-files.html',
                                                    'flag'          => 'pt.png'),
                        'ru-RU'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Russian (Russia) ru-RU',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-russian-language-files.html',
                                                    'flag'          => 'ru.png'),
                        'sr-RS'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Serbian (Serbia) sr-RS',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-serbian-cyrillic-language-files.html',
                                                    'flag'          => 'rs.png'),
                        'sr-YU'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Serbian sr-YU',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-serbian-language-files.html',
                                                    'flag'          => 'rs.png'),
                        'sk-SK'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Slovak (Slovakia) sk-SK',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-slovak-language-files.html',
                                                    'flag'          => 'sk.png'),
                        'sl-SI'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Slovenian (Slovenia) sl-SI',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-slovenian-language-files.html',
                                                    'flag'          => 'si.png'),
                        'es-ES'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Spanish (Spain) es-ES',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-spanish-language-files.html',
                                                    'flag'          => 'es.png'),
                        'sv-SE'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Swedish (Sweden) sv-SE',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-swedish-language-files.html',
                                                    'flag'          => 'se.png'),
                        'tr-TR'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Turkish (Turkey) tr-TR',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-turkish-language-files.html',
                                                    'flag'          => 'tr.png'),
                        'uk-UA'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Ukrainian (Ukraine) uk-UA',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-ukrainian-language-files.html',
                                                    'flag'          => 'ua.png'),
                        'vi-VN'           => array( 'translator'    => 'JoomGallery::TranslationTeam::Vietnamese (Viet Nam) vi-VN',
                                                    'downloadlink'  => 'https://www.en.joomgalleryfriends.net/downloads/joomgallery-for-joomla-3/languages/the-vietnamese-language-files.html',
                                                    'flag'          => 'vn.png')
                      );
