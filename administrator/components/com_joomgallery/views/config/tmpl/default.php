...
JHTML::_('joomconfig.start', 'page5');
    ...
    JHTML::_('joomconfig.row', 'jg_msg_comment_recipients', 'custom', 'COM_JOOMGALLERY_CONFIG_GS_MS_COMMENT_RECIPIENTS', $list, true, '', JText::_('COM_JOOMGALLERY_CONFIG_GS_MS_COMMENT_RECIPIENTS_LONG').(JHtmlJoomSelect::$count > JHtmlJoomSelect::$max_count ? '<br /><br />'.JText::sprintf('COM_JOOMGALLERY_CONFIG_GS_MS_RECIPIENTS_MANY_USERS', JHtmlJoomSelect::$max_count).' '.JText::_('COM_JOOMGALLERY_CONFIG_GS_MS_RECIPIENTS_MANY_USERS_ADDITION') : ''));
    ...
    JHTML::_('joomconfig.row', 'jg_msg_nametag_recipients', 'custom', 'COM_JOOMGALLERY_CONFIG_GS_MS_NAMETAG_RECIPIENTS', $list, true, '', JText::_('COM_JOOMGALLERY_CONFIG_GS_MS_NAMETAG_RECIPIENTS_LONG').(JHtmlJoomSelect::$count > JHtmlJoomSelect::$max_count ? '<br /><br />'.JText::sprintf('COM_JOOMGALLERY_CONFIG_GS_MS_RECIPIENTS_MANY_USERS', JHtmlJoomSelect::$max_count).' '.JText::_('COM_JOOMGALLERY_CONFIG_GS_MS_RECIPIENTS_MANY_USERS_ADDITION') : ''));
    ...
    JHTML::_('joomconfig.row', 'jg_msg_report_recipients', 'custom', 'COM_JOOMGALLERY_CONFIG_GS_MS_REPORT_RECIPIENTS', $list, true, '', JText::_('COM_JOOMGALLERY_CONFIG_GS_MS_REPORT_RECIPIENTS_LONG').(JHtmlJoomSelect::$count > JHtmlJoomSelect::$max_count ? '<br /><br />'.JText::sprintf('COM_JOOMGALLERY_CONFIG_GS_MS_RECIPIENTS_MANY_USERS', JHtmlJoomSelect::$max_count) : ''));
...
JHTML::_('joomconfig.start', 'page18');
    ...
    $watermarkzoom[] = JHTML::_('select.option', '1', JText::_('COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKNORESIZE'));
    $watermarkzoom[] = JHTML::_('select.option', '2', JText::_('COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKHEIGHT'));
    $watermarkzoom[] = JHTML::_('select.option', '3', JText::_('COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKWIDTH'));
