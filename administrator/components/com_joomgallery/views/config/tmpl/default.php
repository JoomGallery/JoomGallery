...
JHTML::_('joomconfig.start', 'page18');
	...
	$watermarkzoomby[] = JHTML::_('select.option', '1', JText::_('COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKHEIGHT'));
    $watermarkzoomby[] = JHTML::_('select.option', '2', JText::_('COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKWIDTH'));
	$mc_jg_watermarkzoomby = JHTML::_('select.genericlist', $watermarkzoomby, 'jg_watermarkzoomby', 'class="inputbox" size="2"', 'value', 'text', $this->_config->jg_watermarkzoomby);
	JHTML::_('joomconfig.row', 'jg_watermarkzoomby', 'custom', 'COM_JOOMGALLERY_CONFIG_DV_GS_WATERMARKZOOMBY', $mc_jg_watermarkzoomby);
