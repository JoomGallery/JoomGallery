...
CREATE TABLE IF NOT EXISTS `#__joomgallery_config` (
  ...
  `jg_replaceimgtitle` int(4) NOT NULL,
  `jg_replaceimgtext` int(4) NOT NULL,
  `jg_replaceimgauthor` int(4) NOT NULL,
  `jg_replaceimgdate` int(4) NOT NULL,
  `jg_replacemetakey` int(4) NOT NULL,
  `jg_replacemetadesc` int(4) NOT NULL,
...
INSERT IGNORE INTO `#__joomgallery_config`
  ...
  /* ### General settings->Replace with meta data ####*/
